...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> handleNotFound(WalletNotFoundException ex) {
        return respond(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(WalletAlreadyExistsException.class)
    public Mono<ResponseEntity<Map<String, Object>>> handleDuplicate(WalletAlreadyExistsException ex) {
        return respond(HttpStatus.CONFLICT, ex.getMessage());
    }

    @ExceptionHandler(AccountClientException.class)
    public Mono<ResponseEntity<Map<String, Object>>> handleAccountClient(AccountClientException ex) {
