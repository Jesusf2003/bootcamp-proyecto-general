...
import com.banco.accounts.client.CustomerClientException;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> handleNotFound(AccountNotFoundException ex) {
        return respond(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(InsufficientFundsException.class)
    public Mono<ResponseEntity<Map<String, Object>>> handleInsufficientFunds(InsufficientFundsException ex) {
        return respond(HttpStatus.UNPROCESSABLE_ENTITY, ex.getMessage());
    }

    @ExceptionHandler(AccountBusinessRuleException.class)
    public Mono<ResponseEntity<Map<String, Object>>> handleBusinessRule(AccountBusinessRuleException ex) {
